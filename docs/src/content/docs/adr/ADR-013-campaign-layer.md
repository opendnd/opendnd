...
- **A sheet is not a character.** The being in the world is a `character`; the `character-sheet` is the record of playing them, and points at it ([ADR-018](/adr/adr-018-fhir-shaped-resources/)). That is what lets a non-player character become a player character without the world changing, and what keeps a player's name out of the fiction.
